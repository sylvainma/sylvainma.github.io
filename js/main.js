jQuery(document).ready(function($){
	...
	function victor_hugo() {
	    maupassant=new String("sylvain.marchienneemileajargmailjeanbaptistepoquelincom");
	    gary="emileajar";
	...
	$('.setEmailAdressText').html(victor_hugo());
	$('.setEmailAdressAnchor').attr("href", "mailto:"+victor_hugo())
	...
	function scrollHijacking (event) {
		...
		function triggerNav() {
			 //update color
			 $('.cd-vertical-nav li a').each(function(){
